...
<header>
        <div class="navbar">
            ...
            <ul>
                ...
                <li><a href="#">Kritik dan Saran Bioskop</a></li>
    ...
    <div class="container-xl" style="background-color: #EEEEEE; padding: top 30px;">
        <h1 class="head">Kritik dan Saran Bioskop</h1>
        <form action="inputreview.php" method="POST">
            ...
            <label for="">Alamat Bioskop</label>
            <div class="input-group flex-nowrap">
                <input type="text" class="form-control" aria-label="Username" aria-describedby="addon-wrapping" style="margin-bottom:20px;">
            </div>

            <label for="">Review Bioskop</label>
            ...
            <div class="input-group mb-3">
                <input type="file" class="form-control" id="inputGroupFile02" style="margin-bottom: 20px;">
            </div>
